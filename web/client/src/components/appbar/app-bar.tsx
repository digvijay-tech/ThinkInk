            ...
            <div className="py-4 select-none">
                <div className="container mx-auto flex flex-row items-center justify-between">
                    <div className="flex flex-row items-center justify-center">
                        ...
                        <h2 className="text-left md:text-center scroll-m-20 text-3xl font-extrabold tracking-tight lg:text-4xl select-none">
                            ThinkInk.
                        </h2>
                    </div>
                ...
                <nav className="select-none">
                    {links.map((link, index) => (
                        <SheetClose key={index} asChild>
                            <Link href={link.path}>
                                <p className={`text-sm font-semibold py-3 px-4 ${(pathname === link.path) && "bg-gray-50"} hover:bg-gray-50`}>
                                    { link.label }
                                </p>
                            </Link>
                        </SheetClose>
                ...
                <SheetFooter>
                    <div className="text-center py-4 border-t select-none">
                        <p className="text-sm text-muted-foreground mb-2">
                            &copy; { new Date().getFullYear() } Digvijaysinh Padhiyar. All rights reserved.
                        </p>
